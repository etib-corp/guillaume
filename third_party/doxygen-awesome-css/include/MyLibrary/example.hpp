...
namespace MyLibrary
{
	...
	class Example
	{
		 ...
		 *   |-----:|-------|-----------------------|--------------------------------------------|
		 *   |    1 | Foo   | A placeholder         | Some lorem ipsum to make
		 * this table wider. | |    2 | Bar   | Also a placeholder    | More
		 * lorem ipsum.                          | |    3 | Baz   | The third
		 * placeholder | More lorem ipsum.                          |
		 ...
		 *   A table wrapped in `<div class="full_width_table">` fills the full
		 * page width. <div class="full_width_table"> | Item | Title |
		 * Description           | More                                       |
		 *   |-----:|-------|-----------------------|--------------------------------------------|
		 *   |    1 | Foo   | A placeholder         | Some lorem ipsum to make
		 * this table wider. | |    2 | Bar   | Also a placeholder    | More
		 ...
		 *   Complex [Doxygen tables](https://www.doxygen.nl/manual/tables.html)
		 * are also supported as seen in @ref multi_row "this example":<br>
		 *   <table>
		 *   <caption id="multi_row">Complex table</caption>
		 *   <tr><th>Column 1                      <th>Column 2 <th>Column 3
		 *   <tr><td rowspan="2">cell row=1+2,col=1<td>cell row=1,col=2<td>cell
		 * row=1,col=3 <tr><td rowspan="2">cell row=2+3,col=2 <td>cell
		 * row=2,col=3 <tr><td>cell row=3,col=1 <td>cell row=3,col=3
		 *   </table>
		 * - <b class="tab-title">Overflow Scrolling</b> The table content is
		 * scrollable if the table gets too wide.<br> | first_column |
		 ...
		 * ## Diagrams
		 *
		 * Graphviz diagrams support dark mode and can be scrolled once they get
		 * too wide:
		 *
