...
void configureButtonRender(
	...
	auto &render = componentRegistry.getComponent<guillaume::components::Render>(
		button.getIdentifier());

	render.setNormalHandler([normalColor](
							  guillaume::ecs::ComponentRegistry
								  &componentRegistry,
							  const guillaume::ecs::Entity::Identifier
								  &identityIdentifier,
							  guillaume::Renderer &renderer) {
	...
	render.setHoveredHandler([hoverColor](
							   guillaume::ecs::ComponentRegistry
								   &componentRegistry,
							   const guillaume::ecs::Entity::Identifier
								   &identityIdentifier,
	...
	render.setClickedHandler([clickedColor](
							   guillaume::ecs::ComponentRegistry
								   &componentRegistry,
							   const guillaume::ecs::Entity::Identifier
								   &identityIdentifier,
...
void Settings::onApplicationAttached(void) {
	...
	configureButtonRender(componentRegistry, *backToMainButton,
						  {90, 90, 255, 255},
						  {130, 130, 255, 255}, {60, 60, 220, 255});

	configureButtonRender(componentRegistry, *settingsLabel,
						  {50, 50, 50, 255},
